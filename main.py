...
def attack(char_name: str, char_class: str) -> str:
    ...
    return (f'{char_name} неизвестный урон')
...
def defence(char_name: str, char_class: str) -> str:
    ...
    return (f'{char_name} блокировал урон')


def special(char_name: str, char_class: str) -> str:
    """Вычисляет последствия применения специального умения."""
    if char_class == 'warrior':
        return (
    ...
    return (f'{char_name} применил неизвестное умение')


def start_training(char_name: str, char_class: str) -> str:
    """Выполняет тренировку навыков или пропускает тренировку."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Выбирает класс игрового персонажа."""
    approve_choice = None
    char_class = None
